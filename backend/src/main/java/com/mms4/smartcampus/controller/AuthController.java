...
public class AuthController {
    ...
    public Map<String,Object> register(@RequestBody Map<String,String> b){UserAccount u=auth.register(b.get("name"),b.get("email"),b.get("password"));String token=auth.login(u.getEmail(),b.get("password"));return session(u,token);}
    ...
    private Map<String,Object> userMap(UserAccount u){Map<String,Object> m=new LinkedHashMap<>();m.put("id",u.getId());m.put("name",u.getName());m.put("email",u.getEmail());m.put("role",u.getRole());m.put("department",u.getDepartment());return m;}
}
